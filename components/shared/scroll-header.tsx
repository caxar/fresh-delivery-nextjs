...
import { AlignJustify, Heart, ShoppingBasket, User } from "lucide-react";
        ...
        <div className=" flex items-center justify-between mt-3 bg-gray3 rounded-xl py-3 px-8">
          ...
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-5">
              ...
              {/* кнопка каталог */}
              <button className="flex items-center gap-2 bg-green3 text-[#fff] text-[20px] py-3 px-5 rounded-xl">
